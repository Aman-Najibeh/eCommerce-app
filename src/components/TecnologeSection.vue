<template>
  <section class="bg mt-16" data-aos="fade-up" >
    <v-container>
      <h1 class="text-h2 text-center ">Technologies</h1>
    </v-container>
  </section>
  <section class="ma-16 pa-10">
    <v-timeline align="start">
      <v-timeline-item v-for="(item, i) in items" :key="i" :dot-color="item.color" :icon="item.icon" fill-dot>
        <v-card  data-aos="fade-left" data-aos-offset="300"
     data-aos-easing="ease-in-sine">
          ...
          <h1 class=" my-4  ma-2">
            ...
            <v-btn :color="item.color" class="ma-4" variant="outlined">
              READ MORE
            </v-btn>
